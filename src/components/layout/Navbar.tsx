...
const NAV_ITEMS = [
  { path: '/esg-overview', ko: 'ESG 개론', en: 'Overview' },
  { path: '/environmental', ko: '환경(E)', en: 'Environment' },
  { path: '/social', ko: '사회(S)', en: 'Social' },
  { path: '/governance', ko: '지배구조(G)', en: 'Governance' },
  { path: '/csr', ko: 'CSR', en: 'CSR' },
  { path: '/social-economy', ko: '사회적 경제', en: 'Social Econ' },
  { path: '/esg-reporting', ko: 'ESG 보고', en: 'Reporting' },
  { path: '/sustainable-invest', ko: '지속가능 투자', en: 'Investment' },
];
      ...
      <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
        <div className="navbar-inner">
          <Link to="/" className="navbar-logo">
            <span className="logo-study">ESG</span>
